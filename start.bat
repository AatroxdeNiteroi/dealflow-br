...
echo.
echo ================================================================
echo  Genesis Radar (Genesis Labs Ltda.) — iniciando backend + frontend
echo ================================================================
echo.
...
start "Genesis Radar · BACKEND (porta 8000)" cmd /K "cd /D %~dp0backend && uv run uvicorn dealflow_api.main:app --reload --port 8000"

REM espera 2 segundos pra backend começar a inicializar antes de subir o frontend
timeout /t 2 /nobreak >nul

start "Genesis Radar · FRONTEND (porta 5173)" cmd /K "cd /D %~dp0frontend && npm run dev"
